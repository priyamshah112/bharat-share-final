...
import com.softglu.bharatshare.base.AppConfig;
import com.softglu.bharatshare.base.Keyword;
import com.softglu.bharatshare.db.AccessDatabase;
import com.softglu.bharatshare.fragment.FileListFragment;
import com.softglu.bharatshare.util.AppUtils;
import com.softglu.bharatshare.util.CommunicationBridge;
import com.softglu.bharatshare.util.CommunicationNotificationHelper;
import com.softglu.bharatshare.util.DynamicNotification;
import com.softglu.bharatshare.util.FileUtils;
import com.softglu.bharatshare.util.HotspotUtils;
import com.softglu.bharatshare.util.NetworkDeviceLoader;
import com.softglu.bharatshare.util.NetworkUtils;
import com.softglu.bharatshare.util.NotificationUtils;
import com.softglu.bharatshare.util.NsdDiscovery;
import com.softglu.bharatshare.util.TimeUtils;
import com.softglu.bharatshare.util.TransferUtils;
import com.genonbeta.CoolSocket.CoolSocket;
import com.genonbeta.CoolSocket.CoolTransfer;
import com.softglu.bharatshare.R;
import com.softglu.bharatshare.model.NetworkDevice;
import com.softglu.bharatshare.model.TextStreamObject;
import com.softglu.bharatshare.model.TransferGroup;
import com.softglu.bharatshare.model.TransferInstance;
import com.softglu.bharatshare.model.TransferObject;
...
public class CommunicationService extends Service
{
    ...
    public static final String ACTION_FILE_TRANSFER = "com.abc.sharefilesz.action.FILE_TRANSFER";
    public static final String ACTION_CLIPBOARD = "com.abc.sharefilesz.action.CLIPBOARD";
    public static final String ACTION_CANCEL_INDEXING = "com.abc.sharefilesz.action.CANCEL_INDEXING";
    public static final String ACTION_IP = "com.abc.sharefilesz.action.IP";
    public static final String ACTION_END_SESSION = "com.abc.sharefilesz.action.END_SESSION";
    public static final String ACTION_SEAMLESS_RECEIVE = "com.genonbeta.intent.action.SEAMLESS_START";
    public static final String ACTION_CANCEL_JOB = "com.abc.sharefilesz.transaction.action.CANCEL_JOB";
    public static final String ACTION_TOGGLE_SEAMLESS_MODE = "com.abc.sharefilesz.transaction.action.TOGGLE_SEAMLESS_MODE";
    public static final String ACTION_REVOKE_ACCESS_PIN = "com.abc.sharefilesz.transaction.action.REVOKE_ACCESS_PIN";
    public static final String ACTION_TOGGLE_HOTSPOT = "com.abc.sharefilesz.transaction.action.TOGGLE_HOTSPOT";
    public static final String ACTION_REQUEST_HOTSPOT_STATUS = "com.abc.sharefilesz.transaction.action.REQUEST_HOTSPOT_STATUS";
    public static final String ACTION_HOTSPOT_STATUS = "com.abc.sharefilesz.transaction.action.HOTSPOT_STATUS";
    public static final String ACTION_DEVICE_ACQUAINTANCE = "com.abc.sharefilesz.transaction.action.DEVICE_ACQUAINTANCE";
    public static final String ACTION_SERVICE_STATUS = "com.abc.sharefilesz.transaction.action.SERVICE_STATUS";
    public static final String ACTION_SERVICE_CONNECTION_TRANSFER_QUEUE = "com.abc.sharefilesz.transaction.action.SERVICE_CONNECTION_TRANSFER_QUEUE";
    public static final String ACTION_TASK_STATUS_CHANGE = "com.abc.sharefilesz.transaction.action.TASK_STATUS_CHANGE";
    public static final String ACTION_TASK_RUNNING_LIST_CHANGE = "com.abc.sharefilesz.transaction.action.TASK_RUNNNIG_LIST_CHANGE";
    public static final String ACTION_REQUEST_TASK_STATUS_CHANGE = "com.abc.sharefilesz.transaction.action.REQUEST_TASK_STATUS_CHANGE";
    public static final String ACTION_REQUEST_TASK_RUNNING_LIST_CHANGE = "com.abc.sharefilesz.transaction.action.REQUEST_TASK_RUNNING_LIST_CHANGE";
    public static final String ACTION_INCOMING_TRANSFER_READY = "com.abc.sharefilesz.transaction.action.INCOMING_TRANSFER_READY";
    public static final String ACTION_TRUSTZONE_STATUS = "com.abc.sharefilesz.transaction.action.TRUSTZONE_STATUS";
    public static final String ACTION_REQUEST_TRUSTZONE_STATUS = "com.abc.sharefilesz.transaction.action.REQUEST_TRUSTZONE_STATUS";
    public static final String ACTION_TOGGLE_WEBSHARE = "com.abc.sharefilesz.transaction.action.TOGGLE_WEBSHARE";
    public static final String ACTION_WEBSHARE_STATUS = "com.abc.sharefilesz.transaction.action.WEBSHARE_STATUS";
    public static final String ACTION_REQUEST_WEBSHARE_STATUS = "com.abc.sharefilesz.transaction.action.REQUEST_WEBSHARE_STATUS";
