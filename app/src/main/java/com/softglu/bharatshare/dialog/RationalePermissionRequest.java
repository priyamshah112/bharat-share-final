...
import com.softglu.bharatshare.activity.MainActivity;
...
public class RationalePermissionRequest extends AlertDialog.Builder
{
                                      ...
                                      boolean killActivityOtherwise)
    {
        ...
        setPositiveButton(R.string.butn_ask, new DialogInterface.OnClickListener()
        {
            ...
            public void onClick(DialogInterface dialogInterface, int i)
            {
                ActivityCompat.requestPermissions(activity, new String[]{mPermissionQueue.permission}, ContentSharingActivity.REQUEST_PERMISSION_ALL);
            }
        });
